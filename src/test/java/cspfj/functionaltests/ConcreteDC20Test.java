...
public class ConcreteDC20Test {
    ...
    public void setUp() throws IOException, SQLException, URISyntaxException,
        ...
        concrete = new Concrete(new String[] { "-p", "cspfj.filter.DC20",
                "-parameter", "cdc.addConstraints=BIN", "" });
    ...
    private int problem(String name, boolean all) throws FileNotFoundException,
        ...
        assertNotSame("Error encountered: " + writer.getThrowable(), Result.UNKNOWN,
                r);
