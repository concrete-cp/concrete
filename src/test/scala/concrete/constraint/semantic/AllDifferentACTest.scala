...
class AllDifferentACTest extends FlatSpec with Matchers {
  ...
  it should "filter" in {
    val v1 = new Variable("1", IntDomain.ofSeq(3))
    val v2 = new Variable("2", IntDomain(0 to 5))
    val v3 = new Variable("3", IntDomain.ofSeq(0, 1, 5))
    val v4 = new Variable("4", IntDomain.ofSeq(0, 5))
    val v5 = new Variable("5", IntDomain.ofSeq(0, 1, 5))
