 ...
 */
public final class IOFibonacciHeap<T extends Identified> extends
        AbstractQueue<T> {
    /**
    ...
    public IOFibonacciHeap(final Key<T> key) {
    ...
    public IOFibonacciHeap(final Key<T> key, final int initSize) {
        this.key = key;
