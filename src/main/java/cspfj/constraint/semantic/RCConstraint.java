...
public class RCConstraint extends AbstractIntConstraint implements
		DynamicConstraint {
	...
	public RCConstraint(IntVariable[] scope) {
		super(scope);
	...
	public RCConstraint(IntVariable[] scope, String name) {
		super(name, scope);
	...
	private static Interval[] initIntervals(final IntVariable[] scope) {
