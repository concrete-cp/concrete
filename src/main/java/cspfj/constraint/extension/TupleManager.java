...
public final class TupleManager {
	...
	private final AbstractAC3Constraint constraint;

	private final int[] tuple;

	private final int arity;

	public TupleManager(final AbstractAC3Constraint constraint,
			final int[] tuple) {
		super();
	...
	public boolean setTupleAfter(final int[] tpl, final int fixed) {
		...
		while (pos < arity) {
			...
			final IntVariable variable = constraint.getVariable(pos);
